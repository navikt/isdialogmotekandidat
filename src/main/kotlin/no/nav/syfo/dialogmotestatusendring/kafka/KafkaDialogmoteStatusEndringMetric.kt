...
const val KAFKA_CONSUMER_DIALOGMOTE_STATUS_ENDRING_SKIPPED_NOT_FERDIGSTILT =
    "${KAFKA_CONSUMER_DIALOGMOTE_STATUS_ENDRING_BASE}_skipped_not_ferdigstilt"
...
val COUNT_KAFKA_CONSUMER_DIALOGMOTE_STATUS_ENDRING_SKIPPED_NOT_FERDIGSTILT: Counter =
    Counter.builder(KAFKA_CONSUMER_DIALOGMOTE_STATUS_ENDRING_SKIPPED_NOT_FERDIGSTILT)
        .description("Counts the number of skipped from topic dialogmote-statusendring - not FERDIGSTILT")
        .register(METRICS_REGISTRY)
