...
import no.nav.syfo.infrastructure.database.MotebehovVurderingRepository
...
class ExternalMockEnvironment private constructor() {
    ...
    val motebehovVurderingRepository = MotebehovVurderingRepository(database = database)
