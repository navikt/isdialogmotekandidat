...
class DialogmotekandidatHistorikkApiSpek : Spek({
    ...
    describe(DialogmotekandidatHistorikkApiSpek::class.java.simpleName) {
        ...
        val ikkeAktuellRepository = externalMockEnvironment.motebehovVurderingRepository
        ...
        fun createIkkeAktuell() {
            database.connection.use {
                ...
                runBlocking { ikkeAktuellRepository.createIkkeAktuell(connection = it, commit = false, ikkeAktuell = ikkeAktuell) }
                it.commit()
            }
        }
